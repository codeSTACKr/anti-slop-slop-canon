...
- **Activation-first router description.** The `SKILL.md` description now names everyday writing tasks such as notes, updates, posts, and emails, after four fresh headless sessions showed the skill never activating on a plain writing prompt. Post-change retests show the skill engaging in both fresh sessions and the first-use gate firing in one of two, recorded in `evals/results/cross-agent-2026-07-18.md`.
