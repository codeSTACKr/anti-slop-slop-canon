...
Keep the normative default canon in `skills/anti-slop-slop-canon/references/defaults.md`; do not copy it into documentation, fixtures, tool-specific rule files, or the router.
